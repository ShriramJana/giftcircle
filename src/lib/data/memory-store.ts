...
export class MemoryStore implements DataStore {
  ...
  async getRegistryBySlug(slug: string): Promise<RegistryPayload | null> {
    ...
    return {
      event: {
        ...
        cost_amount_cents: event.cost_amount_cents,
        cost_memo: event.cost_memo,
        venmo_handle: event.venmo_handle,
        zelle_handle: event.zelle_handle,
  ...
  private seed() {
    ...
    const shower: HostEvent = {
      ...
      start_time: '14:00',
      end_time: null,
      host_note: 'Street parking fills up by 1:30, the lot behind the building is free on Saturdays. Come hungry.',
      background: null,
      cost_mode: 'suggested',
      cost_amount_cents: 2000,
      cost_memo: 'For diapers and the very good cake.',
      venmo_handle: '@maya-whitfield',
      zelle_handle: null,
      cashapp_handle: null,
      message:
